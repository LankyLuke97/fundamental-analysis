...
async def supervisor(base_endpoint: str, tickers: list[str]) -> int:
    ...
    async with AsyncClient() as client:
        download_coroutines = [
            download_one(client, base_endpoint, headers, {"symbol": ticker})
...
def main() -> None:
    ...
    download_many(
        "https://financialmodelingprep.com/stable/historical-price-eod/light", tickers
    )
